<template>
  <div id="home-body">
    <img
      ...
      src="https://cdn.jsdelivr.net/gh/Kinetix-Lee/Kinetix-Lee@master/images/Kinetix.svg"
    ...
    <div id="social-link-group">
      <router-link
        ...
        v-bind:to="'/' + item.index.toLowerCase()"
        v-bind:key="item.name" class="social-link-item">
        {{ item.name }}
      </router-link>
    </div>
  </div>
...
<style>
  ...
  .social-link-item {
    ...
    border: none;
    outline: 0 rgba(33, 33, 33, .2) solid;
